...
Before a mutation, read [effects.md](effects.md) and run its preflight. It owns
allowed effects, approval boundaries, indirect automation, and peer constraints.
Do not infer permission from the state driver.
