...
assert(graph.summary.nodeCount === 2, `expected 2 nodes, got ${graph.summary.nodeCount}`);
assert(graph.summary.edgeCount === 2, `expected 2 edges, got ${graph.summary.edgeCount}`);
