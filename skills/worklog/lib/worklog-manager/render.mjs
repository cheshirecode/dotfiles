...
@media(max-width:900px){body{grid-template-rows:auto auto minmax(0,1fr)}header{display:block;padding:10px 12px}.meta{white-space:normal;overflow-wrap:anywhere}.controls{display:flex;flex-wrap:nowrap;gap:6px;overflow-x:auto;overflow-y:hidden;padding:8px 10px;scrollbar-width:thin}.controls input[type=search]{flex:0 0 min(240px,64vw);width:auto;min-width:180px}.controls button{flex:0 0 auto;width:auto;padding:6px 8px}.controls label{display:inline-flex;align-items:center;gap:4px;flex:0 0 auto;min-width:0;min-height:28px;font-size:12px;white-space:nowrap}.controls input[type=checkbox]{width:16px;height:16px}.chip{flex:0 0 auto;white-space:nowrap}.count{flex:0 0 auto}main{grid-template-columns:1fr;grid-template-rows:minmax(0,1fr)minmax(180px,40dvh)}body.details-collapsed main{grid-template-rows:minmax(0,1fr)0}aside{border-left:0;border-top:1px solid #d7dce4}.node{width:216px}}
</style>
</head>
<body>
...
<label><input type="checkbox" data-relation="depends_on" checked> depends on <span class="count" id="count-rel-depends_on"></span></label>
