...
# nicer prompt
PS1='\n\[\e[30;1m\](\[\e[34;1m\]\u@\h:\w\[\e[30;1m\]) (\[\e[32;1m\]$(command ls -1 | command wc -l | command sed "s: ::g") files, $(command ls -lah | command grep -m 1 total | command sed "s/total //")b\[\e[30;1m\]) (\[\e[36m\]$(parse_git_branch)\[\e[30;1m\])\n--> \[\e[0m\]'
